const Heading = (props) => {
  return (
    <div data-aos="fade-up" className='w-[100%] m-[auto] text-center'>
      <p className={props.src ? 'text-pink-600 pb-2' : 'text-pink-600'}>CampusCrate</p>
      {props.src ? <img className='m-auto' src={props.src} alt="me" width="190" height="35" /> : <h2 className='text-3xl font-bold'>{props.text}</h2>}
    </div>
  )
}
